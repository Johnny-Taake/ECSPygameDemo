...
class TestLoadFontWithFallback:
    ...
    @patch("utils.resources.get_resource_path")
    @patch("utils.resources.pygame")
    ...
    @patch("utils.resources.get_resource_path")
    @patch("utils.resources.pygame")
    def test_load_font_with_file_not_found(
        ...
        mock_pygame.font.Font.side_effect = FileNotFoundError(
            "Font file not found")
        ...
        mock_get_resource_path.assert_called_once_with(
            "assets/fonts/missing.ttf")
        mock_pygame.font.SysFont.assert_called_once_with(
            GameConfig.DEFAULT_FONT, 16)
    ...
    def test_load_font_with_fallback_default_path(
        ...
        mock_get_resource_path.assert_called_once_with(
            GameConfig.DEFAULT_FONT_PATH)
        mock_pygame.font.Font.assert_called_once_with(
            "/path/to/default.ttf", 12)
        assert result == mock_font_instance
...
class TestLoadSoundWithFallback:
    ...
    def test_load_sound_with_fallback_success(
        ...
        result = load_sound_with_fallback(
            "assets/sounds/test.mp3", "test_sound")
    ...
    def test_load_sound_with_fallback_error_returns_none(
        ...
        result = load_sound_with_fallback(
            "assets/sounds/missing.mp3", "missing_sound")

        mock_get_resource_path.assert_called_once_with(
            "assets/sounds/missing.mp3")
